...
const ClothesProducts = () => {
  ...
  const clothesProducts = products.filter((product) =>
  ...
  const currentProduct = clothesProducts.slice(
    indexOfFirstProduct,
    indexOfLastProduct
  );
  ...
  return (
    <>
      ...
      <CategoryContainer>
        <ProductsNums>총 {clothesProducts.length}건</ProductsNums>
      ...
      <Pagination
        ...
        paginate={paginate}
        endPage={endPage}
        totalProducts={clothesProducts.length}
      />
    </>
  );
};
