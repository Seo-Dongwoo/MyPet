...
const ToyProducts = () => {
  ...
  const toyProducts = products.filter((product) =>
  ...
  const currentProduct = toyProducts.slice(
    indexOfFirstProduct,
    indexOfLastProduct
  );
  ...
  return (
    <>
      ...
      <CategoryContainer>
        <ProductsNums>총 {toyProducts.length}건</ProductsNums>
      ...
      <Pagination
        ...
        paginate={paginate}
        endPage={endPage}
        totalProducts={toyProducts.length}
      />
    </>
  );
};
